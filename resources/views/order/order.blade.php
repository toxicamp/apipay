    ...
    <section class="exchange">
        <div class="container">
            <div class="exchange__inner main-payment">
                ...
                @if($payment == 'easypay')
                    <form class="main-payment__box main-payment__box2" action="{{'https://easypay.ua/ua/moneytransfer/transfer2wallet'}}">
                        <div class="payment-amount">Сумма платежа: <span class="payment-amount__sum">{{$price }} {{$currency }}.</span>
                        </div>
