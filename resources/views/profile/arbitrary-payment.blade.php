...
{{--                    </div>--}}
                    ...
                    <div class="list__item arbitrary-payment__list6">
                        <span class="list__status"> @if($iten->status==0) <font color="black">Не оплачен</font> @elseif($iten->blocked==1)<font color="red">Заблокирован</font> @else Выполнен @endif</span>
                    </div>
                </div>
                @endforeach
