...
return [
     ...
     */
    'error_messages' => [
        'wrong_otp'       => "Введен неправильный «Одноразовый пароль».",
        'cannot_be_empty' => 'Одноразовый пароль не может быть пустым.',
        'unknown'         => 'Произошла неизвестная ошибка. Пожалуйста, попробуйте еще раз.',
    ],
